...
LEFT JOIN
  ...
  WHERE 
    account.UserName LIKE '%$string%' OR
    account.Email LIKE '%$string%' OR
    CONCAT(COALESCE(customer.CustomerSurname, staff.LastName), ' ', COALESCE(customer.CustomerName, staff.FirstName)) LIKE '%$string%' OR
    COALESCE(customer.Phone, staff.Phone) LIKE '%$string%'
";

...
function countAll() {
  ...
  xhr.onload = function () {
    ...
    document.querySelector('.circle-wrap .circle .mask.full').style.transform = 'rotate(' + (180 * parseInt((response.percent / 100))) + 'deg)';
    document.querySelector('.circle-wrap .circle .fill').style.transform = 'rotate(' + (180 * parseInt((response.percent / 100))) + 'deg)';
